          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">קוד קופון</th>
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">הנחה</th>
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">עמלה</th>
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">סטטוס קופון</th>
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">סטטוס משתמש</th>
