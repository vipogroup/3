...
const additionalProducts = [
  {
    ...
    fullDescription: "אוזניות גיימינג מקצועיות עם סאונד היקפי 7.1, מיקרופון מתקפל עם ביטול רעשים, ריפוד נוח, ותאורת RGB.",
    price: 349,
    originalPrice: 499,
    category: "גיימינג",
  ...
  },
  {
    ...
    fullDescription: "טאבלט עם מסך 10.1 אינץ' Full HD, מעבד 8 ליבות, 4GB RAM, 64GB אחסון, וסוללה ל-12 שעות.",
    price: 899,
    originalPrice: 1299,
    category: "אלקטרוניקה",
  ...
  },
  {
    ...
    fullDescription: "מסך גיימינג 27 אינץ' ברזולוציית 4K, קצב רענון 144Hz, זמן תגובה 1ms, ותמיכה ב-HDR.",
    price: 1899,
    originalPrice: 2499,
    category: "מחשבים",
  ...
  },
  {
    ...
    fullDescription: "כיסא גיימינג ארגונומי עם תמיכה מלאה בגב, משענות מתכווננות, ריפוד זיכרון, ובסיס מתכת חזק.",
    price: 1299,
    originalPrice: 1799,
    category: "ריהוט",
  ...
  },
  {
    ...
    fullDescription: "שעון ספורט חכם עם GPS מובנה, מדידת דופק 24/7, מעקב שינה, 20 מצבי ספורט, ועמידות למים 50 מטר.",
    price: 799,
    originalPrice: 1099,
    category: "ספורט",
