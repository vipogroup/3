...
const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    body: 'בוצעה רכישה דרך הלינק שלך{{business_name}}. עמלה לזכותך: {{commission_amount}} ש"ח ({{commission_percent}}%).',
    variables: ['commission_percent', 'commission_amount', 'business_name'],
