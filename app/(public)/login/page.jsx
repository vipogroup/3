      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm">הזן את פרטי החשבון שלך</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p id="email-help" className="text-xs text-gray-500 mt-1">
                הזן את האימייל או מספר הטלפון שנרשמת איתם
              </p>
            </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-300 bg-white text-gray-700 font-medium py-3 px-6 rounded-lg transition-all hover:bg-gray-50 hover:border-gray-400 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {googleLoading ? (
              <span className="flex items-center justify-center gap-2">
                <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
