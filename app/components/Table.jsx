...
export function ActionButtons({ onEdit, onDelete, onView }) {
  return (
    <div className="flex items-center gap-2">
      {onView && (
        <button onClick={onView} className="text-blue-600 hover:text-blue-900" aria-label="צפייה">
      ...
      {onDelete && (
        <button onClick={onDelete} className="text-red-600 hover:text-red-900" aria-label="מחיקה">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
