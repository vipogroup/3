...
export default function OrderSummary({
  ...
  if (isSticky) {
    return <div className="md:hidden fixed bottom-0 left-0 right-0 z-40">{summaryContent}</div>;
  }

  // Regular version for desktop
  return (
    <div className="hidden md:block bg-white rounded-lg border shadow-sm p-6">{summaryContent}</div>
  );
}
