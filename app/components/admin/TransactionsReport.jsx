  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <div
          className="rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-md"
          style={{
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-bold" style={{ color: '#1e3a8a' }}>
                {stats.count}
              </p>
            </div>
            <div
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-bold" style={{ color: '#16a34a' }}>
