    ...
    <div className="mb-4 space-y-6">
      ...
      <div className="p-4 bg-purple-50 rounded-xl border-2 border-purple-200">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-purple-900">סרטון (אופציונלי)</h3>
        </div>
        ...
        {!videoUrl && (
          <div>
            ...
            <label 
              ...
              className="flex items-center justify-center gap-2 w-full py-3 px-4 border-2 border-dashed border-purple-300 rounded-lg cursor-pointer hover:bg-purple-100 transition-all"
            >
              {uploadingVideo ? (
                <>
