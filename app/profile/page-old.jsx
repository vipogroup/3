        ...
        <div className="max-w-5xl mx-auto">
          {loading ? (
            ...
            <div>
              ...
              <div className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%)' }}>
              ...
              <div className="px-4 sm:px-6 py-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="lg:col-span-2 border border-gray-200 rounded-lg p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="text-xs font-medium text-gray-500 mb-1 block">שם מלא</label>
                        <p className="text-sm font-medium text-gray-900">{user.fullName || user.name || "—"}</p>
                      </div>
                      <div>
                        <label className="text-xs font-medium text-gray-500 mb-1 block">תפקיד</label>
                      ...
                      <div>
                        <label className="text-xs font-medium text-gray-500 mb-1 block">טלפון</label>
                        <p className="text-sm font-medium text-gray-900">{user.phone || "—"}</p>
                      </div>
                      <div>
                        <label className="text-xs font-medium text-gray-500 mb-1 block">אימייל</label>
                        <p className="text-sm font-medium text-gray-900">{user.email || "—"}</p>
                      </div>
                      {user?.createdAt && (
                        <div>
                          <label className="text-xs font-medium text-gray-500 mb-1 block">תאריך הצטרפות</label>
                      ...
                      {couponCode && (
                        <div>
                          <label className="text-xs font-medium text-gray-500 mb-1 block">קוד קופון</label>
                          <code className="inline-block bg-blue-50 px-3 py-1 rounded text-sm font-bold" style={{ color: 'var(--primary)' }}>
                ...
                <div className="border-t border-gray-200 pt-4 sm:pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm sm:text-base font-semibold text-gray-900">עדכון פרטים</h3>
                    {!isEditing && (
                      <button
