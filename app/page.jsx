...
export default function HomePage() {
  ...
  const loadProducts = () => {
    ...
    console.log("🛍️ Loading products:", prods.length, prods);
    console.log("📸 First product image:", prods[0]?.image);
    setProducts(prods);
  };
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Link
                      ...
                      className="bg-white border-2 border-purple-600 text-purple-600 hover:bg-purple-50 font-semibold py-3 rounded-xl transition-all text-center"
                    >
                      צפה במוצר
                    </Link>
                    <Link
                      href={`/checkout/${product._id}`}
                      className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 rounded-xl transition-all text-center shadow-lg"
                    >
                      🛒 קנה עכשיו
                    </Link>
                  </div>
