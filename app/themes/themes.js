...
export const THEMES = {
  ...
  temu: {
    ...
    primaryButton: "bg-gradient-to-r from-[#FF5E00] to-[#FF006E] hover:opacity-90 text-white font-bold",
    secondaryButton: "bg-[#00B4D8] hover:bg-[#0096C7] text-white",
    buyButton: "bg-gradient-to-r from-[#FF006E] to-[#FF5E00] hover:scale-105 text-white font-extrabold transform transition",
