      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        >
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1">קישור למדיה (MP4 / JPG / PNG)*</label>
              <input
                type="url"
                name="mediaUrl"
                value={form.mediaUrl}
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1">תמונה ממוזערת (לא חובה)</label>
              <input
                type="url"
                name="thumbnailUrl"
