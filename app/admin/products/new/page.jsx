                    ...
                    >
                      ...
                      <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                        <p className="text-sm font-bold text-blue-900">
                          ...
                          ({parseInt(formData.groupPurchaseDetails.closingDays)} ימים סגירה +{' '}
                          {parseInt(formData.groupPurchaseDetails.shippingDays)} ימים משלוח)
                        </p>
                      </div>
                    </div>
                  </>
                  ...
                  {formData.customFields.map((field, index) => (
                    <div key={index} className="p-4 border-2 border-gray-200 rounded-xl bg-gray-50">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 mb-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-cyan-500 transition-all"
                      />
                      <textarea
                        value={field.content}
                        onChange={(e) => {
                        ...
                        className="w-full px-4 py-2 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-cyan-500 transition-all"
                      />
                    </div>
                  ))}
                </div>
