        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-4 xl:gap-5 mb-6 lg:mb-8">
          ...
          <div className="rounded-xl overflow-hidden" style={{ border: '2px solid transparent', backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #1e3a8a, #0891b2)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 2px 10px rgba(8, 145, 178, 0.1)' }}>
            ...
            <div className="p-4 pt-0 grid grid-cols-2 gap-3">
              ...
              {isSuperAdmin && (
              <Link href="/agent/marketplace" className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transition-all border border-green-200">
                ...
                <span className="text-sm font-medium text-green-900">מארקטפלייס עסקים</span>
              </Link>
              )}
              {/* סימולטור מערכת - Super Admin only */}
              {isSuperAdmin && (
              <Link href="/admin/simulator" className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all border border-purple-200">
                ...
                <span className="text-sm font-medium text-purple-900">סימולטור מערכת</span>
              </Link>
              )}
            </div>
            )}
          ...
          <Link href="/admin/crm/dashboard" className="block rounded-xl overflow-hidden transition-all hover:shadow-lg" style={{ border: '2px solid transparent', backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #1e3a8a, #0891b2)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 2px 10px rgba(8, 145, 178, 0.1)' }}>
            <div className="flex items-center justify-between p-4 text-right transition-all hover:bg-gray-50">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base font-bold" style={{ color: '#1e3a8a' }}>CRM - מערכת ניהול לקוחות</span>
              </div>
          ...
          <div className="rounded-xl overflow-hidden" style={{ border: '2px solid transparent', backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #1e3a8a, #0891b2)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 2px 10px rgba(8, 145, 178, 0.1)' }}>
            ...
            <div className="p-4 pt-0 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
              ...
              {canAccess(ADMIN_PERMISSIONS.VIEW_SETTINGS) && (
              <Link href="/admin/site-texts" className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all">
                <svg className="w-5 h-5" style={{ color: '#0891b2' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
                <span className="text-sm font-medium text-gray-900">ניהול טקסטים</span>
              </Link>
              )}
              {canAccess(ADMIN_PERMISSIONS.VIEW_SETTINGS) && (
              ...
              {canAccess(ADMIN_PERMISSIONS.VIEW_SETTINGS) && (
              <Link href="/admin/bot-manager" className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-cyan-50 to-blue-50 hover:from-cyan-100 hover:to-blue-100 transition-all border border-cyan-200">
                <svg className="w-5 h-5" style={{ color: '#0891b2' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {isSuperAdmin && (
          <div className="rounded-xl overflow-hidden" style={{ border: '2px solid transparent', backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #1e3a8a, #0891b2)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 2px 10px rgba(8, 145, 178, 0.1)' }}>
            <button onClick={() => toggleCategory('registration')} className="w-full flex items-center justify-between p-4 text-right transition-all hover:bg-gray-50">
              <div className="flex items-center gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-white" style={{ background: 'linear-gradient(135deg, #1e3a8a 0%, #0891b2 100%)' }}>
                ...
                <span className="text-base font-bold" style={{ color: '#1e3a8a' }}>קישורי התחברות</span>
              </div>
            ...
            <div className="p-4 pt-0 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-2">
                <Link href="/register" className="flex-1 flex items-center gap-3 p-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition-all">
                  ...
                  <span className="text-sm font-medium text-gray-900">הרשמת לקוח</span>
                </Link>
              ...
              <div className="flex items-center gap-2">
                <Link href="/register-agent" className="flex-1 flex items-center gap-3 p-3 rounded-lg bg-purple-50 hover:bg-purple-100 transition-all">
                  <svg className="w-5 h-5" style={{ color: '#7c3aed' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                  </svg>
                  <span className="text-sm font-medium text-gray-900">הרשמת סוכן</span>
                </Link>
              ...
              <div className="flex items-center gap-2">
                <Link href="/register-business" className="flex-1 flex items-center gap-3 p-3 rounded-lg bg-emerald-50 hover:bg-emerald-100 transition-all">
                  ...
                  <span className="text-sm font-medium text-gray-900">הרשמת עסק</span>
                </Link>
