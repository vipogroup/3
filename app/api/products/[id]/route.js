...
export async function PUT(req, { params }) {
  ...
  if (typeof body.fullDescription === "string") update.fullDescription = body.fullDescription.trim();
  ...
  if (body.catalogId || body.catalogSlug) {
    ...
    if (body.catalogId) {
      ...
      catalogDoc = await Catalog.findOne({ slug: String(body.catalogSlug).trim().toLowerCase() }).lean();
      if (!catalogDoc) {
